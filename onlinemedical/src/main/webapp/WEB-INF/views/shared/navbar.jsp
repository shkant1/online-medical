    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${contextRoot}/home"><span class="highlight">Meenakshi</span> <span >Medical Store</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li id="listProducts">
                        <a href="${contextRoot}/show/all/products">Prescription Upload</a>
                    </li>
